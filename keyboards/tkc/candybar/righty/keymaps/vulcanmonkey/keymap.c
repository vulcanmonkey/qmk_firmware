...
[_BL] = LAYOUT(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, MO(_FL),   MO(_FL),      KC_SPC,         KC_RSFT, KC_APP,  KC_LEFT,       KC_DOWN,    KC_RGHT, KC_P0,  KC_PDOT, KC_PENT),

[_FL] = LAYOUT(
  KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL, KC_HOME, KC_WREF, XXXXXXX, RESET, \
  XXXXXXX, KC_BSLS, KC_LBRC, KC_RBRC, KC_SLSH, S(KC_SLSH), KC_PIPE, KC_MINS, KC_LCBR, KC_RCBR, KC_QUOT,     XXXXXXX,     KC_END,  XXXXXXX, XXXXXXX, XXXXXXX, \
  KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX,  KC_PGUP, XXXXXXX, XXXXXXX, XXXXXXX, \
  XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX, XXXXXXX,              XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,KC_PGDN, XXXXXXX, KC_COMM, XXXXXXX),
